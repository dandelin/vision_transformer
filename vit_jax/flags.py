...
def argparser(known_models, known_datasets):
    ...
    parser.add_argument(
        "--output", default=None, help="Where to store the fine tuned model checkpoint."
    )
    parser.add_argument(
        "--copy_to",
        default=None,
    ...
    parser.add_argument(
        "--tfds_manual_dir", default=None, help="Path to manually downloaded dataset."
    )
    ...
    parser.add_argument(
        "--warmup_steps", type=int, default=500, help="How to decay the learning rate."
    )
